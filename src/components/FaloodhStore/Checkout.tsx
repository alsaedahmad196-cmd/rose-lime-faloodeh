...
const FORM_ENDPOINT = "https://formsubmit.co/ajax/roseandlimefaloodeh@gmail.com";
...
export const Checkout: React.FC<CheckoutProps> = ({ items, orderType, onSubmit, onClose }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const total = (items.reduce((s, i) => s + i.price * i.qty, 0) + (orderType === "delivery" ? 5 : 0)).toFixed(2);

    const payload = {
      _subject: "New Faloodeh Order",
      _template: "table",
      _captcha: "false",
